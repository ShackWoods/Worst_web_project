...
Only 'Communication.html' has a link back to index, the others are all standalone
'onlinebanking.html' has no formatting, and thus a completely different style to the rest of the website

### Quality of Written Presentation
'onlinebanking.html' is a bit messy but the rest is solid.
...
It should be noted, indentation is poor and makes it hard to keep track of tag pairs.
